...
import json.xml.project.LessonTwo_Java_OOP.candies.factory.CandyFactory;
import json.xml.project.LessonTwo_Java_OOP.candies.factory.NewPresentFactory;
...
//Change and buy the ready-made Present.
    private static void buyNewPresent(ArrayList<Candy> listOfCandies) {
